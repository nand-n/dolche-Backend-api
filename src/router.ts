...
router.post('/credit-history', creditHistory)  // --------->>>>>Have Error to Be Fixed 

//Credit Worthiness dataset Train
router.post('/equb-worthiness-dataset-train', equbWorthinesssTrainDataset)
//Equb Worthiness of a user based on the ML 
router.post('/equb-worthiness',creditWorthiness)
